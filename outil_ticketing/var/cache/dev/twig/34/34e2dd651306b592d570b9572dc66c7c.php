...
class __TwigTemplate_bb48e27d62c85638318d4d982168550d extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["attribute"]) || array_key_exists("attribute", $context) ? $context["attribute"] : (function () { throw new RuntimeError('Variable "attribute" does not exist.', 393, $this->source); })()), "type", [], "any", false, false, false, 393) == "string")) {
                    ...
                    echo "                                        </td>
                                        <td>";
                    // line 402
                    echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, twig_get_attribute($this->env, $this->source, $context["decision"], "seek", ["object"], "method", false, false, false, 402));
                    echo "</td>
                                    </tr>
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/Users/therese/Documents/GitHub/outil_ticketing/outil_ticketing/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
