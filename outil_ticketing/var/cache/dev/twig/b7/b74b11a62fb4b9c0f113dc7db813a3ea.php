...
class __TwigTemplate_7b4e59065046d5ab37a55b9bd691820d extends Template
{
    private $source;
    private $macros = [];
...
";
                    ...
                    if (twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "htmlBody", [], "any", true, true, false, 149)) {
                        ...
                        if ( !(null === (isset($context["htmlBody"]) || array_key_exists("htmlBody", $context) ? $context["htmlBody"] : (function () { throw new RuntimeError('Variable "htmlBody" does not exist.', 152, $this->source); })()))) {
                            ...
                            // line 158
                            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 158, $this->source); })()), "base64Encode", [(isset($context["htmlBody"]) || array_key_exists("htmlBody", $context) ? $context["htmlBody"] : (function () { throw new RuntimeError('Variable "htmlBody" does not exist.', 158, $this->source); })())], "method", false, false, false, 158), "html", null, true);
                            echo "\"
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["attachment"]) {
                            ...
                            echo ";base64,";
                            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 198, $this->source); })()), "base64Encode", [twig_get_attribute($this->env, $this->source, $context["attachment"], "body", [], "any", false, false, false, 198)], "method", false, false, false, 198), "html", null, true);
                            echo "\" download=\"";
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/mailer.html.twig", "/Users/therese/Documents/GitHub/outil_ticketing/outil_ticketing/vendor/symfony/web-profiler-bundle/Resources/views/Collector/mailer.html.twig");
    }
}
